...
const OAuthButton: React.FC<OAuthButtonProps> = ({ onClick, label, logo }) => (
  <button
    type="button"
    onClick={onClick}
    className="flex items-center h-16 border border-black-400 px-6 rounded-full gap-7 cursor-pointer dark:hover:bg-black-800 hover:bg-gray-100 transition-colors"
  >
